;;; dead-of-night-theme.el --- inspired by VSCode's Tokyo Night theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
;; Added: 
;; Author: 
;; Maintainer:
...
;;
;;; Variables
(defgroup dead-of-night-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom dead-of-night-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'dead-of-night-theme
  :type 'boolean)

(defcustom dead-of-night-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'dead-of-night-theme
  :type 'boolean)

(defcustom dead-of-night-comment-bg dead-of-night-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their legibility."
  :group 'dead-of-night-theme
  :type 'boolean)

(defcustom dead-of-night-padded-modeline nil
...
(def-doom-theme dead-of-night
  ...
  ((bg         '("#0a0a0a" nil       nil            ))
   ...
   (fg-alt     '("#84c4f6" "#c0caf5" "brightwhite"  ))
;;   (fg         '("#80c0f0" "#a9b1d6" "white"        ))
   (fg         '("#66bbff" "#a9b1d6" "white"        ))

   (grey       base4)
   (red        '("#ee4422" "#f7768e" "red"          ))
   ...
   (magenta    '("#cc9af7" "#bb9af7" "magenta"      ))
   (violet     '("#90a5ce" "#9aa5ce" "brightmagenta"))
   (cyan       '("#b4f9f8" "#b4f9f8" "brightcyan"   ))
   (dark-cyan  '("#7dcfff" "#7dcfff" "cyan"         ))
   ; Additional custom colors
   (dark-green '("#88cc77" "#9ece6a" "green"        ))
...
;;   (builtin        red)
   (builtin        grey)
   (comments       (if dead-of-night-brighter-comments base5 base1))
   (doc-comments   (doom-lighten (if dead-of-night-brighter-comments base5 base1) 0.25))
   (constants      orange)
   (functions      blue)
   (keywords       magenta)
   (methods        blue)
   ...
   (-modeline-bright dead-of-night-brighter-modeline)
   (-modeline-pad
    (when dead-of-night-padded-modeline
      (if (integerp dead-of-night-padded-modeline) dead-of-night-padded-modeline 4)))
  ...
  (
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if dead-of-night-comment-bg (doom-lighten bg 0.05)))
   (font-lock-doc-face
...
;;; dead-of-night-theme.el ends here
